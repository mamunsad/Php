...
$sql = "SELECT id, name, type, details, syntax, output, image FROM phpconstant";
...
$sql = "INSERT INTO phpconstant (id, name, type, details, syntax, output, image) VALUES('$id','$name','$type','$details','$syntax','$output','$image')";
